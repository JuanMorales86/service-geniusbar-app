...
import { manifest } from './manifest_xUeDrtRd.mjs';
...
const _page34 = () => import('./pages/test.astro.mjs');
const _page35 = () => import('./pages/testturso.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/TestTurso.astro", _page35],
...
const _args = {
    "middlewareSecret": "79f07a31-2bd3-4253-9537-b53071004ac6"
};
