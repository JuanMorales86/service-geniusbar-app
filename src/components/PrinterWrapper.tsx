...
import type { ServiceOrder } from "@/types/database"; //Se importa el tipo ServiceOrder para tipar los datos de la orden
...
function PrinterWrapper({ order }: { order: ServiceOrder }) { //Recibe una prop 'order' de tipo ServiceOrder
