export interface Links {
  //Interfaz Links: Define la estructura de un objeto que representa un enlace, con dos propiedades:
  title: string;
  url: string;
...
export const linksData: Links[] = [
  //Array linksData: Es un array de objetos que implementan la interfaz Links. Cada objeto en el array representa un enlace con un título y una URL correspondiente.
  {
    title: "Home",
    url: "/",
    requiresAuth: false,
...
export const macServiceInfo = [
  {
    ...
    price: "Presupuesto",
    description:
      "Upgrade o reemplazo de almacenamiento con mejores velocidades, hay modelos que no permiten el cambio",
  },
  {
...
export const iPadServiceInfo = [
  {
    ...
    price: "Presupuesto",
    description:
      "Reemplazo de la pantalla completa (cristal y LCD) o solo el cristal, según el modelo y el daño.",
  },
  {
    ...
    price: "Presupuesto",
    description:
      "Sustitución de la batería para problemas de autonomía o encendido.",
  },
  {
    ...
    price: "Presupuesto",
    description:
      "Solución a problemas de carga o reconocimiento de accesorios por el puerto.",
  },
  {
    service: "Reparación Placa Lógica",
    time: "5-10 días",
    price: "Presupuesto",
    description:
      "Diagnóstico y reparación a nivel de componente para fallos complejos del iPad.",
  },
];
...
export const AppleWatchModels = [
  {
    name: "Apple Watch Series 10/Ultra 3",
    year: "2024-2025",
    support: "Completo",
  },
  {
    name: "Apple Watch Series 9/Ultra 2",
    year: "2023-2024",
    support: "Completo",
  },
  {
    name: "Apple Watch Series 8/Ultra",
    year: "2022-2023",
    support: "Completo",
  },
  ...
  {
    name: "Apple Watch Series 3 y Anteriores",
    year: "2017 y Anteriores",
    support: "Limitado/Básico",
  },
];
...
export const AppleWatchServiceInfo = [
  {
    ...
    price: "Presupuesto",
    description:
      "Reemplazo del cristal roto o la pantalla completa (cristal y LCD) por daños.",
  },
  {
    service: "Cambio de Batería",
    time: "1-2 días",
    price: "Presupuesto",
    description:
      "Sustitución de la batería para mejorar la autonomía o solucionar problemas de encendido.",
  },
  {
    ...
    price: "Presupuesto",
    description:
      "Solución a problemas con la Digital Crown que no gira o presiona, o el botón lateral.",
  },
  {
    ...
    price: "Presupuesto",
    description:
      "Diagnóstico y limpieza interna por exposición a líquidos, intentando restaurar la funcionalidad.",
  },
];
...
export const MagsafeModels = [
  {
    name: "MagSafe 1 (L-tip)",
    year: "2006-2012",
    compatibility: "MacBook/Pro/Air Antiguos",
  },
  {
    name: "MagSafe 2 (T-tip)",
    year: "2012-2015",
    compatibility: "MacBook/Pro/Air Más Recientes",
  },
  {
    name: "USB-C Power Adapter (con Cable)",
    year: "2015-Actual",
    compatibility: "MacBook/Pro/Air Actuales",
  },
];
...
export const MagsafeServiceInfo = [
  {
    ...
    price: "Presupuesto",
    description:
      "Reemplazo del cable dañado o deshilachado, la causa más común de fallo de Magsafe.",
  },
  {
    ...
    price: "Presupuesto",
    description:
      "Diagnóstico y reparación de componentes electrónicos quemados o en cortocircuito dentro del cargador.",
  },
  {
    ...
    price: "Presupuesto",
    description:
      "Identificación de la causa raíz de que el Magsafe no funcione o cargue intermitentemente.",
  },
  {
    ...
    price: "Presupuesto",
    description:
      "Sustitución de la parte del enchufe de pared si está dañada o doblada.",
  },
];
