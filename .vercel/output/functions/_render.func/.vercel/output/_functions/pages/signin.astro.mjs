/* empty css                                     */
import { c as createComponent, r as renderTemplate, d as renderComponent, b as createAstro, m as maybeRenderHead, a as addAttribute } from '../chunks/astro/server_C3fX89Zu.mjs';
...
const $$Signin = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Inicio de Session" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class=""> <div class="flex flex-col items-center justify-center px-6 py-0 mx-auto lg:py-0"> <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white"> ${renderComponent($$result2, "IcoAtom", $$IcoAtom, { "wi": "3rem", "he": "3rem" })}
Genius Bar Accesos
