...
import { $ as $$Image } from '../chunks/_astro_assets_Dj2B3ELb.mjs';
...
const $$Home = createComponent(($$result, $$props, $$slots) => {
  ...
  const plusServices = [
    { image: "https://i.imgur.com/zX9OKvw.png", title: "MacBooks & iPhones", description: "Alta experiencia en recuperaciones rapidas de equipos mojados" }
  ];
