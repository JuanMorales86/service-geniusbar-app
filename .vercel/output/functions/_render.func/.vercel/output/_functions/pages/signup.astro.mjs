/* empty css                                     */
import { c as createComponent, r as renderTemplate, d as renderComponent, b as createAstro, m as maybeRenderHead } from '../chunks/astro/server_C3fX89Zu.mjs';
import { $ as $$Layout } from '../chunks/Layout_BIGIKqIB.mjs';
import { $ as $$IcoAtom } from '../chunks/icoAtom_DoByMB-5.mjs';
...
const $$Signup = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Crear Cuenta de Session" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section> <div class="flex flex-col items-center justify-center px-6 mx-auto lg:py-0"> <a href="/home" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white"> ${renderComponent($$result2, "IcoAtom", $$IcoAtom, { "wi": "3rem", "he": "3rem" })}
Genius Bar Accesos
